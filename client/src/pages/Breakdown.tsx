...
{/*
                            <Table bordered={false} >
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <th scope="row">
                                            <span className="font-sans-xl text-black margin-top-0 tablet:margin-bottom-0">Total Adjusted Gross Income <br />- Deductions</span>
                                        </th>
                                        <span className="font-sans-xl text-black margin-top-0 tablet:margin-bottom-0">$8000 <br />$2000</span>
                                    </tr>
                                    ...
                                    <tr>
                                        <th scope="row"  >
                                            <span className="font-sans-xl text-black margin-top-0 tablet:margin-bottom-0">Taxable Income <br /> * Marginal Tax Rate</span>
                                        </th>
                                        <td>
                                            <span className="font-sans-xl text-black margin-top-0 tablet:margin-bottom-0">$8000 <br />20%</span>
                                        </td>
                                    ...
                                    <tr>
                                        <th scope="row"  >
                                            <span className="font-sans-xl text-black margin-top-0 tablet:margin-bottom-0">Total Federal Tax <br /> -Federal Income Tax Withheld</span>
                                        </th>
                                        <td>
                                            <span className="font-sans-xl text-black margin-top-0 tablet:margin-bottom-0">$8000 <br />$2000</span>
                                        </td>
                                    ...
                                    <tr>
                                        <th scope="row"  >
                                            <span className="font-sans-xl text-black margin-top-0 tablet:margin-bottom-0">Amount Overpaid/Refund</span>
                                        </th>
                                        <td>
                                            <span className="font-sans-xl text-black margin-top-0 tablet:margin-bottom-0">$8000</span>
                                        </td>
